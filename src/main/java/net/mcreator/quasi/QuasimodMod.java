...
@Mod("quasimod")
public class QuasimodMod {
	public static final Logger LOGGER = LogManager.getLogger(QuasimodMod.class);
	public static final String MODID = "quasimod";

	public QuasimodMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		QuasimodModSounds.REGISTRY.register(bus);
